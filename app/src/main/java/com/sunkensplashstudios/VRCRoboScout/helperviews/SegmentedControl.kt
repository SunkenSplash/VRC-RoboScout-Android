...
/*
Copyright 2021 Zach Klippenstein
...
private val TRACK_COLOR = Color.Gray.copy(alpha = .1f)
...
@Composable private fun Thumb(state: SegmentedControlState) {
    Box(
        Modifier
            ...
            .background(if (isSystemInDarkTheme()) Color.Gray else Color.White, BACKGROUND_SHAPE)
    )
}
